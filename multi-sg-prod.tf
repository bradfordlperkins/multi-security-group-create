...
resource "aws_security_group" "test_sg_new_4" {
  name = "000-e1-mgmt-sg-000"
  description = "Allow traffic within the FedRAMP boundary"
  vpc_id = "vpc-036e3718b080038d6"
  tags = {
    Name = "000-e1-mgmt-sg-000"
  }
...
resource "aws_security_group" "test_sg_new_5" {
  name = "003-e1-ncdor-sg-000"
  description = "Allow traffic within the FedRAMP boundary"
  vpc_id = "vpc-032b9226e4661403c"
  tags = {
    Name = "003-e1-ncdor-sg-000"
  }
